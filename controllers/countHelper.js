...
exports.kiraKedah = function(req, res) {
    async.parallel({
        jumlahPelajar: function(callback) {
            Tadika.countDocuments({ createdByNegeri: 'Selangor' }, callback);
        },
        listTadika: function(callback) {
            Tadika
            .find({ createdByNegeri: 'Selangor' })
    ...
    , async function(err, results) {
        ...
        //     rowNew6.getCell(y).value = alltheData[c]._id.kp;
        //     c++;
        ...
        let newfile = path.join(__dirname, "..", "public", "exports", "Selangor-Report.xlsx");
